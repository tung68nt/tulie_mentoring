    ...
    try {
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <Card className="lg:col-span-4 bg-primary/5 border-primary/10" padding="lg">
                        ...
                        <div className="space-y-4 text-xs font-medium text-muted-foreground leading-relaxed">
                            <p>
                                Vai trò <span className="text-primary font-bold">Manager</span> dành cho Ban cố vấn & Giảng viên của Khoa.
                            </p>
                            <p>
                                Thầy/Cô có quyền xem toàn bộ hoạt động, tiến độ mục tiêu, quản lý người dùng và hồ sơ của tất cả sinh viên trong các đợt Mentoring.
                            </p>
                            <ul className="space-y-2 list-disc pl-4 mt-2">
                                ...
                                <li>Quản lý người dùng & phân vai trò</li>
                            </ul>
                        </div>
                    </Card>
                </div>
        ...
        return (
            <div className="p-8 border border-destructive/20 rounded-xl bg-destructive/5 text-center">
                <p className="text-destructive font-semibold">Đã có lỗi xảy ra khi tải dữ liệu dành cho Manager.</p>
            </div>
        );
    }
}
