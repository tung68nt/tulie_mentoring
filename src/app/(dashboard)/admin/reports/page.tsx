    ...
    return (
        <div className="space-y-8 pb-10">
            <div>
                ...
                <p className="text-gray-500 mt-1">Phân tích chuyên sâu về hiệu quả hoạt động của chương trình</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        {[
                            ...
                            <div key={cycle.name} className="space-y-2">
                                <div className="flex justify-between items-center text-sm font-bold">
                                    ...
                                    <span className="text-emerald-600">{cycle.rate}%</span>
                                </div>
                                <Progress value={cycle.rate} size="sm" color={cycle.rate === 100 ? "emerald" : "default"} />
                            </div>
                        ))}
                    </div>
                </Card>
                ...
                <Card className="p-8">
                    ...
                    <div className="space-y-4">
                        {[1, 2, 3, 4].map(i => (
                            <div key={i} className="flex items-center justify-between p-3 rounded-xl border border-gray-50 bg-white">
