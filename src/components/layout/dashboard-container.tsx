    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <div className="lg:ml-[var(--sidebar-width)] min-h-screen flex flex-col transition-all duration-300">
                ...
                <main className="flex-1 px-4 sm:px-6 lg:px-8 pt-20 sm:pt-[88px] pb-10 max-w-[1400px] mx-auto w-full" style={{ paddingBottom: 'max(2.5rem, env(safe-area-inset-bottom, 2.5rem))' }}>
